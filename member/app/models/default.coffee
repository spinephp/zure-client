...
class Default extends Spine.Model
	...
	translate:(key)->
		data = 
			...
			'Compare':['比较']
			'Cancel':['取消']
			'You concern none goods':['你没有关注任何商品']

			# 我的投诉
			'My Complain':['我的投诉']
			'If you do not pleased for our goods or service,please to submit complaints in here.We shell process or reply as quickly as possible.':['如果您对我们的产品或服务不满意，请在这里提交投诉，我们将尽快处理或回复。']
			'Select Order':['选择订单']
			'Complain Record':['投诉记录']
			'Submit Complain':['提交投诉']
			'have complaint':['已投诉']
			'You have none order now.':['你目前没有订单']
			'Status':['状态']
			'Undone':['撤消']
			'Closed':['关闭']
			'Complain content':['抱怨内容']
			'Involve order':['涉及订单']
			'Submit time':['提交时间']
			'You have none complain now.':['你现在没有抱怨。']
			'You can input 500 character.':['你可以输入500个字符。']
			'Submit Complain':['提交投诉']
			...
			'Last':['尾页']
			'Have evaluation':['已评价']
			'View the evaluation details':['查看评价详情']
			'Bask in':['晒单']
			'Bask in and integral':['晒单和积分']
			'The bask in':['晒单']
			'Order no':['订单号']
			'Evaluation of time':['评价时间']
			...
			'records':['条']
			'Browse all':['浏览所有咨询信息']
			'Your comments will be other netizens important purchase reference, and affect commodity grade.':['您的意见将是其他网民重要的购买参考，并影响商品档次。']
			'Product evaluation/bask in':['产品评价/晒单']
			'Camera phones bask in, more convenient':['手机拍照晒单更方便']
			'Satisfaction evaluation':['满意度测评']
			'Comment':['评论']
