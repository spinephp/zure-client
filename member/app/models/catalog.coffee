...
class Catalog
	@tools: [
		...
		{"name":["Community center","社区中心"],option:[{name:["Product eval","商品评价/晒单"],action:"appraise"},{name:["Buying consult","购买咨询"],action:"consult"},{name:["Groom","推荐有礼"],action:"groom"},{name:["Messages","消息精灵"],action:"message"}]}
	]
